...
class MainWindow(tk.Tk):
    ...
    def _add_table_row(self, r):
        ...
        if did not in tab_names:
            ...
            tree.heading('calc', text='计算°C'); tree.column('calc', width=80)
            tree.heading('error', text='误差'); tree.column('error', width=70)
            tree.heading('pass_', text='通过'); tree.column('pass_', width=55)
