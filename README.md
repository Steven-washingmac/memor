...
# 2. Test water bath connection
python water_bath_control.py

# 3. Test TTAG data reception
python ttag_monitor.py --device 230030

# 4. Run small calibration test (5°C → 8°C, ~16 points, ~3-5 min)
python ttag_calibration.py --device 230030 --start 5 --end 8 --step 0.2

# 5. Run full calibration (5°C → 50°C, ~226 points)
python ttag_calibration.py --device 230030 --start 5 --end 50 --step 0.2

# 6. MATLAB fitting
# Open MATLAB, run: ttag_fitting.m
```
